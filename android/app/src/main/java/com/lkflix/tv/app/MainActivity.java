                    ...
                    if ("GET".equalsIgnoreCase(method) && (url.contains("video.php") || url.contains("/iframe/"))) {
                        try {
                            ...
                            String injectScript = "<script>\n"
                                 ...
                                 + "      if (state === 'playing') { p2p.player.pause(true); }\n"
                                 + "      else { p2p.player.play(true); }\n"
                                 + "      return;\n"
                                 + "    }\n"
                                 ...
                                 + "    if (window.jwplayer && typeof window.jwplayer === 'function') {\n"
                                 + "      var jw = window.jwplayer();\n"
                                 + "      if (jw && typeof jw.getState === 'function' && jw.getState() === 'playing') isPlaying = true;\n"
                                 + "    }\n"
                                 + "    var v = document.querySelector('video');\n"
                                 + "    if (v && !v.paused && v.currentTime > 0) { isPlaying = true; }\n"
                                 + "    if (isPlaying) {\n"
                                 ...
                                 + "  } catch(err){}\n"
                                 + "}\n"
                                 + "setInterval(setupPlaybackDetection, 800);\n"
